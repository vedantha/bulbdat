...
var g = lineArea.gradient("L(561,1364,1060,1792)#000-#FFF-#FFF"); //gradient definition for the line svg
var g2 = lineArea.gradient("L(1185.3,1898.82,562.61,2441.68)#FFF-#FFF-#000"); 
//gradient definition for the line svg -^^

var lineOneFirst = lineArea.path("M 561.885 1364.28 ").attr({stroke : g, strokeWidth : "2"});

// draws a line from x1 y1 to x2 y2 , attr defines stroke attributes
var lineOneMid = lineArea.path("M 1068 1798.82").attr({stroke : "#FFF", strokeWidth : 2});
var lineOneLast = lineArea.path("M 1185.3 1898.82").attr({stroke : g2, strokeWidth : 2});
/*
Next Up: Animation */
// To do:
